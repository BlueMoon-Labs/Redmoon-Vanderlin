...
/obj/item/paper/proc/show_paper_hud(mob/user)
	var/dat = {"<!DOCTYPE HTML PUBLIC \"-//W3C//DTD HTML 4.01 Transitional//EN\" \"http://www.w3.org/TR/html4/loose.dtd\">
		<html><head>[BROWSER_UTF8_META]<style type=\"text/css\">
...
/obj/item/paper/proc/openhelp(mob/user)
	user << browse({"<HTML><HEAD>[BROWSER_UTF8_META]<TITLE>Paper Help</TITLE></HEAD>
	<BODY>
...
/obj/item/paper/Topic(href, href_list)
	...
	if(href_list["write"])
		...
		var/t = browser_input_text(usr, "Enter what you want to write:", "Write", null, MAX_MESSAGE_LEN, TRUE, FALSE)
