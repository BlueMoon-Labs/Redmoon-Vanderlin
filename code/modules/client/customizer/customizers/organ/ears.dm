...
/datum/customizer/organ/ears/dracon
	customizer_choices = list(/datum/customizer_choice/organ/ears/dracon)
	allows_disabling = FALSE

/datum/customizer_choice/organ/ears/dracon
	name = "Dracon ears"
	organ_type = /obj/item/organ/ears
	sprite_accessories = list(
		/datum/sprite_accessory/ears/cobrahood,
...
/datum/customizer/organ/ears/moth
	customizer_choices = list(/datum/customizer_choice/organ/ears/moth)
	allows_disabling = FALSE

/datum/customizer_choice/organ/ears/moth
	name = "Moth ears"
	organ_type = /obj/item/organ/ears
	sprite_accessories = list(
		/datum/sprite_accessory/ears/antenna_simple1,
