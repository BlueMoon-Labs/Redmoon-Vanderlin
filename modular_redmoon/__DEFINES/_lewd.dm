...
//Cum overlays
#define CUM_DMI 'modular_redmoon/icons/from_bluemoon/effects/cumoverlay.dmi'
...
GLOBAL_LIST_INIT(lewd_moans_male, list(
	'modular_redmoon/sound/interactions/moan_m1.ogg',
	'modular_redmoon/sound/interactions/moan_m2.ogg',
	'modular_redmoon/sound/interactions/moan_m3.ogg'
))

GLOBAL_LIST_INIT(lewd_moans_female, list(
	'modular_redmoon/sound/interactions/moan_f1.ogg',
	'modular_redmoon/sound/interactions/moan_f2.ogg',
	'modular_redmoon/sound/interactions/moan_f3.ogg',
	'modular_redmoon/sound/interactions/moan_f4.ogg',
	'modular_redmoon/sound/interactions/moan_f5.ogg',
	'modular_redmoon/sound/interactions/moan_f6.ogg',
	'modular_redmoon/sound/interactions/moan_f7.ogg'
))
// BLUEMOON ADD START
GLOBAL_LIST_INIT(lewd_softmoans_female, list(
	'modular_redmoon/sound/interactions/softmoan1.ogg',
	'modular_redmoon/sound/interactions/softmoan2.ogg',
	'modular_redmoon/sound/interactions/softmoan3.ogg',
	'modular_redmoon/sound/interactions/softmoan4.ogg',
	'modular_redmoon/sound/interactions/softmoan5.ogg',
	'modular_redmoon/sound/interactions/softmoan6.ogg'
))
// BLUEMOON ADD END
// Kissing sounds
GLOBAL_LIST_INIT(lewd_kiss_sounds, list(
	'modular_redmoon/sound/interactions//kiss1.ogg',
	'modular_redmoon/sound/interactions/kiss2.ogg',
	'modular_redmoon/sound/interactions/kiss3.ogg',
	'modular_redmoon/sound/interactions/kiss4.ogg',
	'modular_redmoon/sound/interactions/kiss5.ogg'
))
...
// BLUEMOON ADD хвостики!
#define INTERACTION_REQUIRE_TAIL (1<<13)
#define INTERACTION_REQUIRE_KNOT (1<<14) // not replace INTERACTION_REQUIRE_PENIS, use both
