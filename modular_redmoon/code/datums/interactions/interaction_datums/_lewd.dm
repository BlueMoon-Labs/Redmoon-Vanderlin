...
/mob/living/proc/do_oral_self(mob/living/user, var/fucktarget = "penis")
	...
	playsound(get_turf(src), pick('modular_redmoon/sound/interactions/bj1.ogg',
									...
									'modular_redmoon/sound/interactions/bj5.ogg',
									'modular_redmoon/sound/interactions/bj6.ogg',
									'modular_redmoon/sound/interactions/bj7.ogg',
									'modular_redmoon/sound/interactions/bj8.ogg',
									'modular_redmoon/sound/interactions/bj9.ogg',
									'modular_redmoon/sound/interactions/bj10.ogg',
									'modular_redmoon/sound/interactions/bj11.ogg'), 50, 1, -1)
...
/mob/living/proc/do_cockfuck(mob/living/target)
	...
	var/list/noises = list(
		...
		'modular_redmoon/sound/interactions/bang6.ogg',
	)
